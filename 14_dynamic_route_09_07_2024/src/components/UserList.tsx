...
//OMIT - позволяет исключать из интерфейса прямо на месте, что позволяет избежать передачи лишнего или неправильного типа.
...
class UserList extends Component<IProps, IState> {
  ...
  render(): ReactNode {
    return this.state.isDetails ? (
      ...
      //WE NEED TO HAND OVER PROPS' CONTENTS USING SPREAD (...this.state userDetails)
      //TO PREVENT NULL HANDOVER: check this.state.userDetails
